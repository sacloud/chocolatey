...
$url        = 'https://github.com/sacloud/terraform-provider-sakuracloud/releases/download/v0.10.1/terraform-provider-sakuracloud_windows-386.zip' # download url, HTTPS preferred
$url64      = 'https://github.com/sacloud/terraform-provider-sakuracloud/releases/download/v0.10.1/terraform-provider-sakuracloud_windows-amd64.zip' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'terraform-provider-sakuracloud*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
